...
```
Usa'homework' llndo lo que aprendiste de HTML vas a crear un nuevo documento dentro de la carpeta de amado 'cv.html'. En el mismo vas crear tu propio Curriculum, deberá tener las siguientes secciones:
